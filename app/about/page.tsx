      ...
      <div className=' flex flex-col lg:flex-row mx-auto lg:gap-32 gap-5'>
        ...
        >
          ...
          >
            ...
            unraveling the mysteries of the legal system and aiding individuals
            in their journey through it.
          </motion.p>
          ...
          >
            ...
            rights and debunking any misconceptions about Law and the Indian
            Legal System.
          </motion.p>
          ...
          >
            {skills &&
              skills.map((skill, i) => (
                <li
                  key={i}
                  className='flex align-middle items-center gap-1 text-Green'
                >
                  <BsFillSignpostFill />
                  {skill}
                </li>
